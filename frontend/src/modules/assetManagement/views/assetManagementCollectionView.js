  ...
  var AssetCollectionView = OriginView.extend(
    {
      ...
      postRender: function () {
        this.initPaging();
        // init lazy scrolling
        $('.asset-management-assets-container').on(
          'scroll',
          this._doLazyScroll
        );
      ...
      appendAssetItem: function (asset) {
        this.$('.asset-management-collection-inner').append(
          new AssetItemView({ model: asset }).$el
        );
      },
      ...
      fetchCollection: function (cb) {
        ...
        this.collection.fetch({
          ...
          success: _.bind(function (collection, response) {
            ...
            $('.asset-management-no-assets').toggleClass(
              'display-none',
              this.fetchCount > 0
            );
