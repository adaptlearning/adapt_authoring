  ...
  var AssetManagementModalTagsView = OriginView.extend(
    {
      ...
      events: {
        'click .asset-management-modal-tags-toolbar-close':
      ...
      postRender: function () {
        ...
        this.$('.asset-management-modal-tags-item')
          .first()
          .addClass('selected');
      },
      ...
      moveUpThroughItems: function () {
        ...
        var $selectedItem = this.$(
          '.asset-management-modal-tags-item.selected'
        );
        var $prevItem = $selectedItem.prevAll(
          '.asset-management-modal-tags-item:visible:first'
        );
      ...
      moveDownThroughItems: function () {
        ...
        var $nextItem = $selectedItem.nextAll(
          '.asset-management-modal-tags-item:visible:first'
        );
      ...
      searchItems: function (event) {
        ...
        this.$('.asset-management-modal-tags-item').each(function (event) {
          var itemText = $('.asset-management-modal-tags-item-inner', $(this))
            .text()
            .toLowerCase();
        ...
        this.$('.asset-management-modal-tags-item:visible:first')
          .addClass('selected')
          .focus();
        this.$('.asset-management-modal-tags-search-input').focus();
      },
      ...
      addFilter: function () {
        var selectedTag = {
          title: this.$('.asset-management-modal-tags-item.selected').attr(
            'data-title'
          ),
          id: this.$('.asset-management-modal-tags-item.selected').attr(
            'data-id'
          ),
        };
