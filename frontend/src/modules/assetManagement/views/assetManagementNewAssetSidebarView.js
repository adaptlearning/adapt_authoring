...
define(function (require) {
  ...
  var AssetManagementNewAssetSidebarView = SidebarItemView.extend(
    {
      events: {
        'click .asset-management-new-sidebar-save-button':
          'onSaveNewAssetClicked',
        'click .asset-management-new-sidebar-cancel-button':
          'onCancelNewAssetClicked',
      },

      onSaveNewAssetClicked: function () {
        this.updateButton(
          '.asset-management-new-sidebar-save-button',
          Origin.l10n.t('app.saving')
        );
