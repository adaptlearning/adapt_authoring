  ...
  var AssetManagementSidebarView = SidebarItemView.extend(
    {
      events: {
        ...
        'click .asset-management-sidebar-filter-button':
      ...
      onClearSearchClicked: function (event) {
        ...
        this.$('.asset-management-sidebar-filter-search')
          .val('')
          .trigger('keyup', [true]);
      },
      ...
      onAddTagClicked: function (event) {
        ...
        this.collection.each(function (tag) {
          ...
          if (
            !_.contains(titles, tag.get('title')) &&
            !_.contains(usedTagsTitles, tag.get('title'))
          ) {
      ...
      addTagToSidebar: function (tag) {
        ...
        this.$('.asset-management-sidebar-add-tag')
          .parent()
          .after(template(data));
      },
