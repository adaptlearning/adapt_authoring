...
define(function (require) {
  ...
  var ContextMenuView = Backbone.View.extend({
    ...
    renderItems: function () {
      ...
      _.each(
        this.collection.where({ type: this.type }),
        function (item) {
    ...
    toggleMenu: function (view, e) {
      var isSameType =
        view &&
        view.model.get('_type') ===
          (this.contextView.model && this.contextView.model.get('_type'));
      var isSameModel =
        view &&
        view.model.get('_id') ===
          (this.contextView.model && this.contextView.model.get('_id'));
