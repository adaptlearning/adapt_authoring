  ...
  var EditorMenuItemView = EditorOriginView.extend(
    {
      ...
      setupEvents: function () {
        ...
        this.$el
          .closest('.editor-menu')
          .on('mousemove', _.bind(this.handleDrag, this));
      },
      ...
      editMenuItem: function () {
        ...
        Origin.router.navigateTo(
          'editor/' + courseId + '/' + type + '/' + menuItemId + '/edit'
        );
      },
      ...
      deleteItemPrompt: function (event) {
        ...
        this.listenToOnce(
          Origin,
          'editorView:removeItem:' + this.model.get('_id'),
          this.deleteItem
        );
        this.listenToOnce(
          Origin,
          'editorView:cancelRemoveItem:' + this.model.get('_id'),
        ...
        Origin.Notify.confirm({
          ...
          text:
            Origin.l10n.t('app.confirmdelete' + this.model.get('_type')) +
            '<br />' +
            '<br />' +
            Origin.l10n.t('app.confirmdeletewarning' + this.model.get('_type')),
      ...
      deleteItem: function (event) {
        ...
        Origin.router.navigateTo(
          'editor/' + Origin.editor.data.course.id + '/menu' + parentId
        );
      ...
      handleDrag: function (event) {
        ...
        var $currentLayer = $(
          ".editor-menu-layer[data-over='true'] > .editor-menu-layer-inner"
        );
        ...
        this.autoScrollTimer = window.setInterval(function () {
          ...
          if (clientY < offsetTop + SCROLL_THRESHOLD) {
            ...
            clientY >
            $currentLayer.height() + offsetTop - SCROLL_THRESHOLD
          ) {
            scrollAmount = SCROLL_INCREMENT;
          }
