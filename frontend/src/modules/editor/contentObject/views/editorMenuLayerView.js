  ...
  var EditorMenuLayerView = EditorOriginView.extend(
    {
      ...
      setHeight: function () {
        ...
        var controlsHeight = this.$(
          '.editor-menu-layer-controls'
        ).outerHeight();

        this.$('.editor-menu-layer-inner').height(
          windowHeight - (offsetTop + controlsHeight)
        );
      },
      ...
      addNewMenuItem: function (event, type) {
        ...
        newMenuItemModel.save(null, {
          ...
          success: _.bind(function (model) {
            ...
            newMenuItemView.$el
              .children('.editor-menu-item-inner')
              .attr('data-id', model.get('_id'));
            if (type === 'page') {
      ...
      pasteMenuItem: function (event) {
        ...
        Origin.trigger(
          'editorView:paste',
          this._parentId,
          this.$('.editor-menu-item').length + 1
        );
      },
