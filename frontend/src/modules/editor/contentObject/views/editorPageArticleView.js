  ...
  var EditorPageArticleView = EditorOriginView.extend(
    {
      ...
      preRender: function () {
        this.listenToEvents();
        Origin.editor.data._collapsedArticles =
          Origin.editor.data._collapsedArticles || {};
      },
      ...
      addBlockView: function (blockModel, scrollIntoView) {
        ...
        if (shouldAppend) {
          ...
          // 'splice' block into the new position
        ...
        this.$('.article-blocks').append(
          new EditorPasteZoneView({ model: blockModel }).$el
        );
      },
        ...
        model.save(
          ...
          },
          {
            ...
            error: function () {
              Origin.Notify.alert({
                type: 'error',
                text: Origin.l10n.t('app.erroraddingblock'),
              });
            },
          }
        );
      ...
      deleteArticlePrompt: function (event) {
        ...
        Origin.Notify.confirm({
          ...
          text:
            Origin.l10n.t('app.confirmdeletearticle') +
            '<br />' +
            '<br />' +
            Origin.l10n.t('app.confirmdeletearticlewarning'),
      ...
      restoreCollapsedState: function () {
        if (
          !Origin.editor.data._collapsedArticles.hasOwnProperty(
            this.model.get('_id')
          )
        )
          return;
        ...
        this.model.set(
          '_isCollapsed',
          Origin.editor.data._collapsedArticles[this.model.get('_id')]
        );
      },
      ...
      collapseArticle: function () {
        ...
        this.$('.article-content').velocity(
          shouldCollapse ? 'slideUp' : 'slideDown',
          duration
        );
      },
    },
