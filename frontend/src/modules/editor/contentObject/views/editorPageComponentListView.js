  ...
  var EditorPageComponentListView = EditorOriginView.extend(
    {
      ...
      events: {
        ...
        'click .editor-component-list-sidebar-exit, .click-capture':
          'closeView',
      ...
      setupCollection: function () {
        var availableComponents = _.where(this.model.get('componentTypes'), {
      ...
      postRender: function () {
        ...
        this.$el
          .css({ right: this.$('.editor-component-list-sidebar').width() * -1 })
      ...
      closeView: function () {
        var self = this;
        this.$el.velocity(
          { right: this.$('.editor-component-list-sidebar').width() * -1 },
          {
            duration: 400,
            easing: 'easeOutQuart',
      ...
      renderComponentList: function () {
        ...
        this.collection.each(function (componentType) {
          ...
          this.$('.editor-component-list-sidebar-list').append(
            new EditorPageComponentListItemView({
              model: componentType,
      ...
      onScreenResize: function (windowWidth, windowHeight) {
        this.$('.editor-component-list-sidebar-list').height(
          windowHeight - this.headerHeight
        );
      },
    },
    {
