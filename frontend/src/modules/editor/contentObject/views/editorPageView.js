  ...
  var EditorPageView = EditorOriginView.extend(
    {
      ...
      render: function () {
        var returnVal = EditorOriginView.prototype.render.apply(
          this,
          arguments
        );
      ...
      addArticleViews: function () {
        ...
        this.$('.page-articles').append(
          new EditorPasteZoneView({ model: prePasteArticle }).$el
        );
      ...
      addArticleView: function (articleModel, scrollIntoView) {
        ...
        this.$('.page-articles').append(
          new EditorPasteZoneView({ model: articleModel }).$el
        );
      ...
      openContextMenu: function (event) {
        if (!event)
          return console.log(
            'Error: needs a current target to attach the menu to...'
          );
