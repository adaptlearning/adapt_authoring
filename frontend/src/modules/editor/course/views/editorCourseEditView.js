  ...
  var EditorCourseEditView = EditorOriginView.extend(
    {
      ...
      getAttributesToSave: function () {
        ...
        var newAttributes = _.omit(
          this.model.attributes,
          Object.keys(this.originalAttributes)
        );
        ...
        componentTypes.fetch({
          ...
          success: _.bind(function () {
            var componentModel = new ComponentModel({
              ...
              _type: 'component',
              _component: 'text',
              _componentType: componentTypes.findWhere({ component: 'text' })
                .attributes._id,
              _layout: 'full',
            });
            componentModel.save(null, {
              ...
              success: function () {
                Origin.router.navigateTo(
                  'editor/' + componentModel.get('_courseId') + '/menu'
                );
              },
            });
          }, this),
