  ...
  Origin.on('editor:extensions', function (data) {
    Origin.trigger('location:title:update', {
      breadcrumbs: [
        'dashboard',
        'course',
        { title: Origin.l10n.t('app.editorextensions') },
      ],
    ...
    if (Origin.previousLocation.route2 === 'page') {
      backButtonRoute =
        '#/editor/' + route1 + '/page/' + Origin.previousLocation.route3;
    ...
    Origin.contentPane.setView(EditorExtensionsEditView, {
      model: new Backbone.Model({ _id: route1 }),
    });
  });
});
