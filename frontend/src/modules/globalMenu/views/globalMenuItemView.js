  ...
  var GlobalMenuItemView = Backbone.View.extend(
    {
        ...
        _.defer(
          _.bind(function () {
            ...
            if (!this.model.get('_isSubMenuItem')) {
              ...
              this.listenTo(
                Origin,
                'globalMenu:globalSubMenuView:remove',
                this.remove
              );
            }
          }, this)
      ...
      setupChildren: function () {
        ...
        this.children = this.collection.where({
          parent: this.model.get('text'),
        });
      ...
      setupHover: function () {
        ...
        this.$('.global-menu-item-inner').hover(
          _.bind(function () {
            ...
            _.each(
              ...
              function (subMenuItem) {
                $('.global-menu-submenu-inner').append(
                  new GlobalMenuItemView({
                    model: subMenuItem,
