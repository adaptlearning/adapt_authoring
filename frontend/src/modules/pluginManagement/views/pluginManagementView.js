  ...
  var PluginManagementView = OriginView.extend(
    {
      ...
      preRender: function () {
        Origin.trigger('location:title:update', {
          title: Origin.l10n.t('app.' + this.pluginType + 'management'),
        });
        this.getColl().fetch({
          success: this.renderPluginTypeViews.bind(this),
        });
      },
      ...
      evaluatePluginTypeCount: function (pluginTypes) {
        if (pluginTypes.length === 0) {
          this.$('.pluginManagement-plugins').append(
            Origin.l10n.t('app.noplugintypes')
          );
        }
      },
