  ...
  var ScaffoldAssetView = Backbone.Form.editors.Base.extend(
    {
      ...
      events: {
        ...
        'click .scaffold-asset-external-input-save':
          'onExternalAssetSaveClicked',
        'click .scaffold-asset-external-input-cancel':
          'onExternalAssetCancelClicked',
      },
      ...
      renderData: function (id) {
        ...
        this.$el.html(
          Handlebars.templates[this.constructor.template]({
            value: this.value,
            type: this.assetType,
      ...
      checkValueHasChanged: function () {
        ...
        if (this.key === 'heroImage')
          return this.saveModel({ heroImage: value });
      ...
      removeCourseAsset: function (contentTypeId, contentType, fieldname) {
        this.fetchCourseAsset(
          ...
          function (error, courseassets) {
            ...
            var listModels = courseassets.models
              ? courseassets.models.slice()
              : courseassets.slice();
            ...
            listModel.destroy({
              ...
              error: function () {
                console.error(
                  'Failed to destroy courseasset record',
                  listModel.get('_id')
                );
                return;
              },
      ...
      saveModel: function (attributesToSave) {
        ...
        if (alternativeAttribute) {
          attributesToSave[alternativeAttribute] =
            Origin.scaffold.getCurrentModel().attributes;
        }
      ...
      toggleExternalAssetField: function (shouldShow) {
        this.$('.scaffold-asset-external-input').toggleClass(
          'display-none',
          !shouldShow
        );
        this.$('.scaffold-asset-buttons').toggleClass(
          'display-none',
          shouldShow
        );
      },
