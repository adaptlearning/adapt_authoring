  ...
  var TenantView = OriginView.extend({
    ...
    onDisableTenantClicked: function (event) {
      ...
      Origin.Notify.confirm({
        type: 'confirm',
        text: Origin.l10n.t('app.disabletenantconfirm') + ' ' + this.model.get('name'),
    ...
    onDeleteClicked: function () {
      ...
      Origin.Notify.confirm({
        type: 'confirm',
        text: Origin.l10n.t('app.confirmdeletetenant', {
    ...
    onEnableClicked: function (event) {
      ...
      Origin.Notify.confirm({
        type: 'confirm',
        text: Origin.l10n.t('app.enabletenantconfirm') + ' ' + this.model.get('name'),
        callback: function (confirmed) {
          if (confirmed) {
    ...
    updateModel: function (key, value) {
      ...
      this.model.save(toSave, {
        ...
        error: function (err) {
          return self.onError(Origin.l10n.t('app.updatetenanterror'));
        }
      });
    },
