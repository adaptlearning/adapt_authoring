...
Origin.prototype.startServer = function (options) {
  ...
  async.series([
    function(callback) {
      installHelpers.getInstalledVersions(function(error, versions) {
        installedServerVersion = versions.adapt_authoring;
        installedFrameworkVersion = versions.adapt_framework;
        callback(error);
      });
    },
    function(callback) {
      ...
      installHelpers.getLatestVersions(function(error, versions) {
        latestServerTag = versions.adapt_authoring;
    ...
    function(callback) {
      ...
      if (semver.lt(installedServerVersion, latestServerTag)) {
      ...
      if (semver.lt(installedFrameworkVersion, latestFrameworkTag)) {
