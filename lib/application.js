...
AdaptBuilder.prototype.createServer = function (options, cb) {
  var server = express();
...
AdaptBuilder.prototype.startServer = function () {
  // configure server
  var serverOptions = {};
...
AdaptBuilder.prototype.restartServer = function () {
  var app = this;
  if (app._httpServer) {
...
AdaptBuilder.prototype.run = function () {
