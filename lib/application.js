...
AdaptBuilder.prototype.preload = function(){
  //@todo add ability for module to report a problem and halt preload
  if(0 === this._preloadModules.length){
    this.emit('modulesReady',this);
  }else{
    this._preloadModules.shift()(this,this.preload.bind(this));
  } 
};
