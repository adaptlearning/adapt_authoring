...
ContentManager.prototype.setupRoutes = function () {
  ...
  rest.get('/content/schema', function(req, res, next) {
    ...
    var memo = {
      ...
      globals: { _components: {}, _extensions: {}, _menu: {}, _theme: {} }
    };
    ...
    function processGlobals(pluginType, schema, memo) {
      var props = memo.globals[pluginType.key].properties;
      if(!props) {
        props = { type: 'object', properties: {} };
      }
      return _.extend(memo.globals[pluginType.key].properties, {
    ...
    function generateComponentProperties(schema) {
      var data = _.clone(schema);
      data.properties = _.clone(that._contentSchemas.component.properties);
      data.properties.properties = {
        type: 'object',
        properties: _.clone(_.omit(schema.properties, blackList))
      };
      return data;
    }
    ...
    function processPluginLocations(pPluginType, schema, memo, callback) {
      ...
      async.each(Object.keys(schemaPluginLocations), function(key, eachCallback) {
        ...
        // HACK this is needed to check against applied menu/theme in schemas.js
      ...
      async.each(Object.keys(memo.schemas), function(key, callback) {
        ...
        try { // Append plugin globals to the course schema
          if (key === 'course' && schema.properties._globals.properties) {
            _.extend(schema.properties._globals.properties, globals);
          }
        ...
        async.each(memo.pluginTypes, function(plugin, cb) {
          ...
          // components don't define properties like this
          if(pluginType === 'component' || !memoData) {
            return cb();
          }
