                ...
                switch (plugin.type) {
                  ...
                  case 'menu':
                    ...
                    async.each(Object.keys(schemaPluginLocations.properties), function(key, nestedCallback) {
                      ...
                      // needed to check against applied theme in schemas.js
                      pluginLocations.properties[keys[0]].name = schema.name;
                      contentModelExtras[key] = _.extend(contentModelExtras[key], pluginLocations.properties);
        ...
        async.each(Object.keys(schemas), function(key, callback) {
          ...
          if (contentModelExtras[key]) {
            value.properties.menuSettings = {
              type: "object",
              properties: contentModelExtras[key]
            };
          }
