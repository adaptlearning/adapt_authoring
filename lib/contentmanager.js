  ...
  rest.get('/content/schema', function (req, res, next) {
    ...
    database.getDatabase(function (err, db) {
      ...
      var plugins = [
        ...
        { collectionType: 'themetype', type: 'theme', key: 'theme' },
        { collectionType: 'menutype', type: 'menu', key: 'menu' }
      ];
      ...
      async.eachSeries(plugins, function (plugin, outerCallback) {
                  ...
                  case 'theme':
                    ...
                    async.each(Object.keys(schemaPluginLocations.properties), function(key, nestedCallback) {
                      ...
                      switch(plugin.type) {
                        ...
                        case 'theme':
                          contentModelThemes[key] = _.extend(contentModelThemes[key], pluginLocations.properties);
                          break;
                      }
        ...
        async.each(Object.keys(schemas), function(key, callback) {
          ...
          if (!_.isEmpty(contentModelThemes[key])) {
            console.log(key, contentModelThemes[key], value.properties.themeSettings);
