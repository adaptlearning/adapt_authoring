...
MongooseDB.prototype.connect = function(dbName) {
  ...
  this.conn.once('error', function(){ console.log('Database Connection failed, please check your database'); }); //added to give console notification of the problem
...
/**
 * Returns a import class for the type specified
 * @param {String} type The type of importer
 * @return {object|boolean} returns false if the requested type is not registered
 */
MongooseDB.prototype.getImporter = function (type) {
  ...
  switch(type){
      case 'json-schema':
        return new (require('./mongoose.orm.js'))();
      break;
      default:
         return false;
      break;
