...
FileStorage.prototype.getFileContents = function (filePath, callback) {
  logger.log(
    'warn',
    'FileStorage#getFileContents must be implemented by extending object!'
  );
...
FileStorage.prototype.putFileContents = function (
  filePath,
  options,
  buffer,
  callback
  ...
  logger.log(
    'warn',
    'FileStorage#putFileContents must be implemented by extending object!'
  );
...
FileStorage.prototype.createReadStream = function (
  filePath,
  options,
  callback
) {
  logger.log(
    'warn',
    'FileStorage#createReadStream must be implemented by extending object!'
  );
...
FileStorage.prototype.createWriteStream = function (
  filePath,
  options,
  callback
) {
...
FileStorage.prototype.deleteFile = function (filePath, callback) {
  logger.log(
    'warn',
    'FileStorage#deleteFile must be implemented by extending object!'
  );
 ...
 * @param {function} callback - function of the form function(error)
 */
FileStorage.prototype.copyAsset = function (
  asset,
  sourceTenant,
  destinationTenant,
  callback
  ...
  logger.log(
    'warn',
    'FileStorage#copyFile must be implemented by extending object!'
  );
...
FileStorage.prototype.moveFile = function (oldPath, newPath, callback) {
  logger.log(
    'warn',
    'FileStorage#moveFile must be implemented by extending object!'
  );
...
FileStorage.prototype.processFileUpload = function (
  file,
  storageInfo,
  options,
  cb
  ...
  logger.log(
    'warn',
    'FileStorage#processFileUpload must be implemented by extending object!'
  );
...
FileStorage.prototype.createDirectory = function (filePath, callback) {
  logger.log(
    'warn',
    'FileStorage#createDirectory must be implemented by extending object!'
  );
...
FileStorage.prototype.removeDirectory = function (filePath, callback) {
  logger.log(
    'warn',
    'FileStorage#removeDirectory must be implemented by extending object!'
  );
...
FileStorage.prototype.getDirectoryListing = function (filePath, callback) {
  logger.log(
    'warn',
    'FileStorage#getDirectoryListing must be implemented by extending object!'
  );
...
FileStorage.prototype.getFileStats = function (filePath, callback) {
  logger.log(
    'warn',
    'FileStorage#getFileStats must be implemented by extending object!'
  );
...
function getStorage(type, callback) {
  ...
  pluginManager.getPlugin('filestorage', type, function (error, pluginInfo) {
    if (error) {
      logger.log(
        'warning',
        'Failed to retrieve filestorage plugin: ' + type,
        error
      );
      callback(error);
    } else {
