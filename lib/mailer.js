...
const validateSettings = function(settings) {
  const errors = [
    this.useSmtpConnectionUrl && !this.connectionUrl && 'smtpConnectionUrl',
    !this.useSmtpConnectionUrl && !this.user && 'smtpService',
    !this.useSmtpConnectionUrl && !this.pass && 'smtpPassword',
