...
OutputPlugin.prototype.writeThemeVariables = function(courseId, theme, themeVariables, destinationFolder, next) {
  var destinationFile = path.join(destinationFolder, Constants.Folders.Less, Constants.Folders.ThemeVariablesDirectory, Constants.Filenames.ThemeVariables);
