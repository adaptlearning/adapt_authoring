...
var Constants = {
    ...
    Filenames: {
      ...
      Main: 'index.html',
      Rebuild: '.rebuild',
      CustomStyle: '2-customLess.less',
      Bower: 'bower.json',
      Package: 'package.json',
      Metadata: 'metadata.json',
      ThemeVariables: '1-themeVariables.less',
...
OutputPlugin.prototype.writeThemeVariables = function(courseId, theme, themeVariables, destinationFolder, next) {
  var destinationFile = path.join(destinationFolder, Constants.Folders.Less, Constants.Folders.CustomStyleDirectory, Constants.Filenames.ThemeVariables);
  ...
  async.series([
    function(seriesCallback) {
      ...
      // theme properties
      async.eachSeries(Object.keys(theme.properties), function(key, innerCallback) {
        var nestedProps = theme.properties[key].properties;
    ...
    function(seriesCallback) {
      ...
      if (modifiedProperties.length === 0) {
        ...
        fs.removeSync(path.join(destinationFolder, Constants.Folders.Less, Constants.Folders.CustomStyleDirectory, Constants.Filenames.ThemeVariables));
