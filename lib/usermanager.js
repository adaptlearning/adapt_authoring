...
exports = module.exports = {
  ...
  hasPermission: function(action, user, contentItem, next) {
    var resource = permissions.buildResourceString(user.tenant._id, '/api/user/resetpassword/' + contentItem);
    permissions.hasPermission(user._id, action, resource, next);
  },
