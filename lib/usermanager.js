 ...
 // create reusable transporter object using SMTP transport
  ...
  init: function (app) {
    var usermanager = this;
      ...
      rest.get('/useremail/:email', function (req, res, next) {
        ...
        if (emailParam) {
          ...
          usermanager.checkEmailExists({email:emailParam}, function(err, checkRes){
            ...
            if (checkRes) {
              ...
              var tokenCreated = usermanager.generateDate();

              // save token to db
              usermanager.createUserPasswordReset({email:emailParam,token:token,tokenCreated: tokenCreated },function(err, res){
              });
              // Send Link to User                            
              usermanager.sendTokenMail(token, host, checkRes.email, function(error,info){                
