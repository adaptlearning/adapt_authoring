...
exports = module.exports = {
  ...
  getCurrentUser: function () {
    try { // the below JSON operations ensure any ObjectIds become strings
      const passportUser = process.domain.session.passport.user;
      return JSON.parse(JSON.stringify(passportUser));
    } catch(e) {
      return false;
    }
  },
