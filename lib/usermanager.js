 ...
 * CONSTANTS
 */
var MAX_TOKEN_AGE = 0.2; // in hours
...
exports = module.exports = {
  ...
  generateDate: function () {
    ...
    console.log("CurrentTime" + expDate);      
    return expDate;
  },
          ...
          usermanager.checkEmailExists({email:emailParam}, function(err, checkRes){
            ...
            if (checkRes) {
              ...
              usermanager.createUserPasswordReset({email:emailParam,token:token,tokenCreated: tokenCreated },function(err, res){
                console.log("createuserpassword error:"+err);
                console.log("createuserpassword result:"+res);
              });
              // Send Link to User                            
